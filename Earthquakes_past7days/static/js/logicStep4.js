...
// Pass our baseMaps layers into our layers control 
// Then we add a control to the map that will allow the user
// to change which over layers are visible.
...
L.geoJSON(data, {
  ...
  pointToLayer: function(feature, latlng) {
    ...
    // We set the style for each circleMarker using our styleInfo function.
      ...
      // Then we add the earthquakes to our map:
